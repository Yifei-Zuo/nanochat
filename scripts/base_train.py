...
parser.add_argument("--attn-impl", type=str, default="flash", choices=["flash", "parallax"], help="attention implementation: flash (FA3/SDPA softmax) or parallax (Parameterized Local Linear Attention)")
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        window_pattern=args.window_pattern, attn_impl=args.attn_impl,
    )
