    ...
    if last_step:
        ...
        save_checkpoint(
            ...
            optimizer.state_dict(),
            {
                ...
                # Serialize the full GPTConfig via asdict so every field round-trips
                # (incl. attn_impl) — a hand-built dict silently drops new fields and
                # breaks chat_eval's strict load.
